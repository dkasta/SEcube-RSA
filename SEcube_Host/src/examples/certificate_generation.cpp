...
// *  \brief This file is an example about how to generate a certificate
// *  \date 20/05/2021
// */
//
...
//		}
//
//		l1->L1FindKey(keyI, found);
//
//		if (found) {
//			try {
//				cout << "Deleting RSA key..." << flush;
//				se3Key keyToDel = {.id = keyI};
//				l1->L1KeyEdit(keyToDel, L1Commands::KeyOpEdit::SE3_KEY_OP_DELETE);
//			} catch (L1Exception& e) {
//				cout << "\t\tFAIL" << endl;
//				return 1;
...
//		try {
//			l1->L1KeyEdit(keyy, L1Commands::KeyOpEdit::SE3_KEY_OP_ADD_GEN_RSA);
//		} catch (L1Exception& e) {
//			cout << "\t\tFAIL" << endl;
//			return 1;
//		}
...
//		cout << "\tOK (took " << duration.count() << " ms) (certificate stored to " << pwd << "/cert.pem)" << endl;
//		ofstream certFile;
//		certFile.open("cert.pem");
//		certFile << cert;
//		certFile.close();
//
//		SEcube_certificate_info inf = {
//				.cert_id = 14,
//				.issuer_key_id = keyI,
//				.subject_key_id = keyI,
//				.serial_str = "01234567890123333389",
//				.not_before = "20200202171300",
//				.not_after = "20250202171300",
//				.issuer_name = "C=UK,O=PoliMI,CN=PoliMI CA",
//				.subject_name = "C=IT,O=PoliMI,CN=PoliMI CA"
//		};
//
//		cout << "Generating X.509 certificate..." << flush;
//		start = chrono::high_resolution_clock::now();
//		try {
//			l1->L1CertificateEdit(L1Commands::CertOpEdit::SE3_CERT_OP_ADD, inf);
//		} catch (L1Exception& e) {
//			cout << "\tFAIL" << endl;
//			return 1;
//		}
...
//		cout << "Getting X.509 cert list..." << flush;
//		start = chrono::high_resolution_clock::now();
//		try {
//			l1->L1CertificateList(certList);
//		} catch (L1Exception& e) {
//			cout << "\tFAIL" << endl;
//			return 1;
//		}
//		end = chrono::high_resolution_clock::now();
//		duration = chrono::duration_cast<chrono::milliseconds>(end - start);
//		cout << "\tOK (took " << duration.count() << " ms) (IDs=";
...
//		start = chrono::high_resolution_clock::now();
//		try {
//			l1->L1CertificateEdit(L1Commands::CertOpEdit::SE3_CERT_OP_DELETE, inf);
//		} catch (L1Exception& e) {
//			cout << "\tFAIL" << endl;
//			return 1;
//		}
...
//		cout << ")" << endl;
//
//		cout << "\nRSA demo successfully completed" << endl;
//	} else {
