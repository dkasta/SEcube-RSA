...
//
///*! \file  rsa_demo.cpp
// *  \brief This file is an example about how to send a buffer to be encrypted and decrypted
// *  \date 20/05/2021
// */
//
...
//
//		const auto plainTextStr = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.";// Proin placerat ornare nunc vitae placerat. ";
...
//		cout << ")" << endl;
//
//		cout << "Encrypting plaintext..." << flush;
//		start = chrono::high_resolution_clock::now();
//		try {
//			l1->L1Encrypt(plainLen, plainText, cipher,
//					L1Algorithms::Algorithms::RSA, 0, key, false);
//		} catch (L1Exception& e) {
//			cout << " FAIL" << endl;
//			return 1;
//		}
...
//		cout << ")" << endl;
//
//		cout << "Decrypting ciphertext..." << flush;
//		start = chrono::high_resolution_clock::now();
//		try {
...
//
//		bool verified;
//		cout << "Verifying signature..." << flush;
//		start = chrono::high_resolution_clock::now();
//		try {
//			l1->L1Verify(plainLen, plainText, key, false, signLen,
//					sign, verified);
//		} catch (L1Exception& e) {
//			cout << "\t\tFAIL" << endl;
//			return 1;
