...
namespace L1Commands {
	...
	struct RSA_Options {
		enum{
			...
			SE3_RSA_X509_GEN = 8,
			SE3_RSA_X509_GET = 9,
			SE3_RSA_X509_DELETE = 10,
			SE3_RSA_X509_LIST = 11,
			SE3_RSA_X509_FIND = 12,
		};
	};
	...
	struct KeyOpEdit {
		enum {
			...
			SE3_KEY_OP_ADD_RSA = 5,			/**< Use this value to insert a new RSA key passing manually the RSA key value. */
			SE3_KEY_OP_ADD_GEN_RSA = 6			/**< Use this value to insert a key generated with the the algorithm on the SEcube. */
		};
	};

	enum CertOpEdit {
		SE3_CERT_OP_ADD = 0,		/**< Use this value to insert a new certificate passing manually the certificate infos. */
		SE3_CERT_OP_DELETE = 1,		/**< Use this value to delete a certificate. */
	};
}
