...
class L1AsymmCryptException : public L1Exception {
public:
	virtual const char* what() const throw() override {
			return "Error while performing asymmetric crypto operation!";
		}
};
...
class L1SignatureException : public L1Exception {
public:
	virtual const char* what() const throw() override {
			return "Error while performing signature operation!";
		}
};
